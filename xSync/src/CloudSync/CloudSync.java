...
public class CloudSync extends Thread{
	...
	private String sync_directory_father_name;
	private String original_directory_father_name;
	...
	public void run() {
		...
		File sync_father = new File(sync_directory_path_bak);
		sync_directory_father_name = sync_father.getName();
		
		File original_father = new File(original_directory_path);
		original_directory_father_name = original_father.getName();
		...
		file_sync_operation.fileSyncOperation(md5_array_sync, md5_array_original, sync_directory_father_name,
				original_directory_father_name);
